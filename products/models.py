...
class Product(models.Model):
    ...
    datetiem_created = models.DateTimeField(auto_now_add=True, verbose_name=_('created date'))
    datetiem_modified = models.DateTimeField(auto_now=True, verbose_name=_('last modified date'))
...
class Comment(models.Model):
    ...
    datetime_created = models.DateTimeField(auto_now_add=True, verbose_name=_('created date'))
    datetiem_modified = models.DateTimeField(auto_now=True, verbose_name=_('modified date'))
